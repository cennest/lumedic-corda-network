 ...
 */
@CordaService
open class DatabaseService(val services: ServiceHub) : SingletonSerializeAsToken() {
    ...
    private fun prepareStatement(query: String, params: Map<Int, Any>): PreparedStatement {
        ...
        params.forEach { (key, value) ->
            when (value) {
                ...
                is LocalDateTime -> preparedStatement.setTimestamp(key, Timestamp.valueOf(value))
